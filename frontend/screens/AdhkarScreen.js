/**
 * Adhkar Screen - أذكار
 * Islamic remembrance and daily supplications with categories
 */
...
const AdhkarScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.headerText}>أذكار وأدعية</Text>
        <Text style={styles.subtitleText}>
          Authentic Adhkar from Quran & Sunnah
        </Text>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerReference}>- Surah Al-Ahzab (33:35)</Text>
        </View>
      </ScrollView>
    </View>
  );
